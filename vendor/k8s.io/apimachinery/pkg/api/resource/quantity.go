...
// NewBinaryQuantity returns a new Quantity representing the given
// value * 2^(10*scale) in BinarySI format.
func NewBinaryQuantity(value int64, scale Scale) *Quantity {
	return &Quantity{
		i:      int64Amount{value: value, scale: scale},
		Format: BinarySI,
	}
